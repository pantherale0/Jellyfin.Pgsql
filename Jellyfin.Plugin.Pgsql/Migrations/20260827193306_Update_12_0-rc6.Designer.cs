...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.BaseItemEntity", b =>
                {
                    ...
                    b.HasIndex("SeriesName", "DateCreated");
                    ...
                    b.HasIndex("Type", "TopParentId", "ChannelId", "StartDate");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PlaybackActivity", b =>
                {
                    ...
                    b.HasIndex("ChannelId", "DatePlayed")
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PlaybackActivityDaily", b =>
                {
                    ...
                    b.ToTable("PlaybackActivityDaily", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.TasteModelEvalRun", b =>
                {
                    ...
                    b.ToTable("TasteModelEvalRuns", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.UserData", b =>
                {
                    ...
                    b.HasIndex("UserId", "PlaybackPositionTicks");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.UserTasteBecauseYouRecommendation", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "SourceItemId", "Rank");

                    b.HasIndex("UserId", "SourceKind");

                    b.ToTable("UserTasteBecauseYouRecommendations", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.UserTasteProfile", b =>
                {
                    ...
                    b.ToTable("UserTasteProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.UserTasteRecommendation", b =>
                {
                    ...
                    b.ToTable("UserTasteRecommendations", (string)null);
                });

            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.UserTasteRecommendationImpression", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "ItemId", "ServedAt");

                    b.ToTable("UserTasteRecommendationImpressions", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PlaybackActivity", b =>
                {
                    b.HasOne("Jellyfin.Database.Implementations.Entities.Security.Device", "Device")
                        .WithMany()
